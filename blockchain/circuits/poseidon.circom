// Vendored from iden3/circomlib (poseidon.circom + poseidon_constants.circom),
// reduced to the t=3 (2-input) parameters used by the rating nullifier circuit.
// Parameters generated by the reference script
